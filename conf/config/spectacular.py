...
SPECTACULAR_DEFAULTS = {
    ...
    "SWAGGER_UI_DIST": "//fastly.jsdelivr.net/npm/swagger-ui-dist@5.2.0",
    "SWAGGER_UI_FAVICON_HREF": "//fastly.jsdelivr.net/npm/swagger-ui-dist@5.2.0/favicon-32x32.png",
    ...
    "TITLE": "django-restful-project-template",
    "DESCRIPTION": "Welcome to the Django Restful Project Template! This template provides a solid foundation for building powerful and scalable RESTful APIs using the Django framework. Whether you're starting a new project or looking to enhance an existing one, this template offers a structured setup with best practices in mind.",
    "TOS": None,
